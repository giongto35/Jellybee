...
class GL2JNIView extends GLSurfaceView {
	...
	public GL2JNIView(Activity context) {
		super(context);
	...
	public GL2JNIView(Activity context, boolean translucent, int depth,
			int stencil) {
		super(context);
		...
		SoundInGame.sound_context = context.getApplicationContext();
	}
	...
	private static class Renderer implements GLSurfaceView.Renderer {
		...
		public void onDrawFrame(GL10 gl) {
			...
			GL2JNILib.step();
			if (FacebookSharing.mGl == null)
				FacebookSharing.mGl = gl;
//			if (GL2JNIActivity.ay > 2) {
//				GL2JNILib.onKey(39, true);
//				GL2JNILib.onKey(37, false);
//			} else if (GL2JNIActivity.ay < -2) {
//				GL2JNILib.onKey(37, true);
//				GL2JNILib.onKey(39, false);
//			} else {
//				GL2JNILib.onKey(37, false);
//				GL2JNILib.onKey(39, false);
//			}
//			
//			if (GL2JNIActivity.ax > 2) {
//				GL2JNILib.onKey(40, true);
//				GL2JNILib.onKey(38, false);
//			} else if (GL2JNIActivity.ax < -2) {
//				GL2JNILib.onKey(38, true);
//				GL2JNILib.onKey(40, false);
//			} else {
//				GL2JNILib.onKey(38, false);
//				GL2JNILib.onKey(40, false);
//			}
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (action == KeyEvent.ACTION_DOWN) {
			GL2JNILib.onKey(keyCode, true);
		} else if (action == KeyEvent.ACTION_UP) {
			GL2JNILib.onKey(keyCode, false);
		}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:
			GL2JNILib.onPointer(0, (int) event.getX(), (int) event.getY());
			break;
		case MotionEvent.ACTION_MOVE:
			GL2JNILib.onDrag((int) event.getX(), (int) event.getY());
			break;
		case MotionEvent.ACTION_UP:
			GL2JNILib.onPointer(1, (int) event.getX(), (int) event.getY());
			break;
		}
