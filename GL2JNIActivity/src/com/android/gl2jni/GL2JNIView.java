...
class GL2JNIView extends GLSurfaceView {
	...
	public GL2JNIView(Context context, boolean translucent, int depth,
		...
		SoundInGame.sound_context = context;
	}
	...
	private static class Renderer implements GLSurfaceView.Renderer {
		public void onDrawFrame(GL10 gl) {
			GL2JNILib.step();
//			if (GL2JNIActivity.check == 1) {
//				Application.onKey(40, true);
//				Application.onKey(38, false);
//				
//			} else if (GL2JNIActivity.check == -1) {
//				Application.onKey(40, false);
//				Application.onKey(38, true);
//				
//			} else {
//				Application.onKey(40, false);
//				Application.onKey(38, false);
